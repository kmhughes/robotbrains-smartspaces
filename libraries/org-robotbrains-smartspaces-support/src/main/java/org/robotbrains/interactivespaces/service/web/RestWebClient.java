...
public interface RestWebClient extends ManagedResource {
	 ...
	 *             if transfer was not successful
	 */
	String performGet(String sourceUri, Charset charset)
			throws SmartSpacesException;
	 ...
	 *             if transfer was not successful
	 */
	String performPut(String sourceUri, String putContent)
			throws SmartSpacesException;
	 ...
	 *
	 * @return the total number of connections, or {@code 0} if there is no
	 *         limit
	 */
